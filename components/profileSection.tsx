...
export default function ProfileSection() {
    const [scrollBehavior, setScrollBehavior] = React.useState("2022 - 2023");
            ...
            <div className="bg-bgColor rounded-2xl backdrop-filter backdrop-blur-lg bg-opacity-40 pt-8 pb-8 shadow-lg shadow-black/50">
                <div className="flex flex-wrap pb-8">
                    ...
                    <div className="px-6 grid grid-cols-1 gap-4 lg:grid-cols-3 pt-5">
                        ...
                        <CardProfile Name="Gilang Putra" Uname="@gilang.pfx" Desc="Leader of IT Club and Networking Enginner. Heyy, welcome to itclub 👋" Color="danger" Image="https://media.discordapp.net/attachments/1125397316971528272/1140492754703614042/7ac1b4ed-125c-4e4b-9fd1-d9174b8e1808.png?width=255&height=453" Jobs="#TinjuDibalasTinju" LinkIG="https://www.instagram.com/gilang.pfx" TTL="03 Feb 2005" LinkProfile="https://punyagilang.carrd.co"/>
