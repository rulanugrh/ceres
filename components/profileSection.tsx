            ...
            <div className="bg-bgColor rounded-2xl backdrop-filter backdrop-blur-lg bg-opacity-40 pt-8 pb-8 shadow-lg shadow-black/50">
                <div className="flex flex-wrap pb-8">
                    ...
                    <div className="px-6 grid grid-cols-1 gap-4 lg:grid-cols-3 pt-5">
                        ...
                        <CardProfile Name="Fawaaz Nurul" Uname="@fwaziz" Desc="Vice Chairman of IT Club and MOBA Player. Heyy, welcome to itclub 👋" Color="primary" Image="https://media.discordapp.net/attachments/1125397316971528272/1150272589156077648/355104567_807159264035393_2635183912194957517_n.png?width=575&height=575" Jobs="#BusetKataGuaMah" LinkIG="https://instagram.com" TTL="31 Jun 2006"/>
                        ...
                        <CardProfile Name="Dina Amelia" Uname="@dinamelia" Desc="Secretary of IT Club and Brand Ambasador. Heyy, welcome to itclub 👋" Color="secondary" Image="https://media.discordapp.net/attachments/1125397316971528272/1150272922548711474/370458481_852775633134896_7515706922328557590_n.png?width=575&height=575" Jobs="#XoXoo" LinkIG="https://instagram.com" TTL="02 Mar 2007"/>
